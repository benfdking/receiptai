...
T = TypeVar("T", bound="StatementStartBalance")


@_attrs_define
class StatementStartBalance:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        statement_start_balance = cls(
            amount=amount,
            currency=currency,
        )

        statement_start_balance.additional_properties = d
        return statement_start_balance
