...
T = TypeVar("T", bound="ReviewApproverType1")


@_attrs_define
class ReviewApproverType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        review_approver_type_1.additional_properties = d
        return review_approver_type_1
