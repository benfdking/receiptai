...
T = TypeVar("T", bound="ReviewCopilotApproverType1")


@_attrs_define
class ReviewCopilotApproverType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        review_copilot_approver_type_1 = cls(
            id=id,
            first_name=first_name,
            last_name=last_name,
        ...
        review_copilot_approver_type_1.additional_properties = d
        return review_copilot_approver_type_1
