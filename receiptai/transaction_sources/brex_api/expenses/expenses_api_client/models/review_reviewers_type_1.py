...
T = TypeVar("T", bound="ReviewReviewersType1")


@_attrs_define
class ReviewReviewersType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        review_reviewers_type_1 = cls(
            reviewer=reviewer,
            status=status,
        )

        review_reviewers_type_1.additional_properties = d
        return review_reviewers_type_1
